...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnDamagedEvent, float, DamageAmount, const UDamageType*, DamageType);
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnDamagedEventCpp, float, const UDamageType*);
